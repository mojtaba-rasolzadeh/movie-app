...
const RecommendationsTvShows = ({ tvShows }) => {
  return (
    <Box
      sx={{
        display: "flex",
    ...
    >
      {tvShows.results?.map((tv) => (
        <Box
          key={tv.id}
          sx={{ position: "relative", width: 160, mb: 2, borderRadius: "20px" }}
        >
          <Avatar
            variant="rounded"
            sx={{ width: 1, height: 240, borderRadius: "20px" }}
          ...
          <Box
            sx={{
              ...
              width: 1,
              backgroundImage:
                "linear-gradient(to top, rgb(32 32 32 / 94%) 90px, rgb(12 11 2 / 0%) 100%)",
              borderRadius: "17px",
            }}
          />
          <Box
...
export default RecommendationsTvShows;
