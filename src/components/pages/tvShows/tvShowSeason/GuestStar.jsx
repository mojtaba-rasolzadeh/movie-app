...
const GuestStar = ({ id, name, profile_path, character }) => {
    return (
        <Box key={id} sx={{ position: 'relative', width: 160, mb: 2, borderRadius: '20px' }}>
            <Avatar variant="rounded" sx={{ width: 1, height: 240, borderRadius: '20px' }}
